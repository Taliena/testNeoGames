...
export class Button extends PIXI.Sprite {
    ...
    constructor(text: string, backgroundColor: number, lineColor: number, width?: number) {
        super();
        let wdt = width | 150;
    ...
    public setOpenedState(style: BUTTON_STYLE): void {
    ...
    public generatePosition(x, y): void {
        this.x = x;
        this.y = y;
    }
